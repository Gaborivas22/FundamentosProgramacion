...
/* 
Leer un arreglo de NxM de números. En un arreglo de una dimensión almacenar los números
pares, en otro arreglo de una dimensión almacenar los números impares. Mostrar los 3 arreglos.
*/
